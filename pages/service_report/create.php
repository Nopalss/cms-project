...
try {
    ...
    $sql = "SELECT s.schedule_key, s.schedule_id, s.tech_id ,s.netpay_key, c.* FROM schedules s JOIN customers c ON s.netpay_key = c.netpay_key WHERE s.schedule_key = :id";
