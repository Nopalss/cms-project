...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class=" d-flex flex-column-fluid">
        <!--begin::Container-->
        <div class="container">
            <form method="post" class="form row" action="<?= BASE_URL ?>controllers/report/dismantle/create.php">
                ...
                <div class="col-md-6 mb-10">
                    <div class="card card-custom shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Alasan</label>
                                <textarea class="form-control" id="exampleTextarea" required name="alasan" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Action</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="part_removed" required />
                            </div>
                            <div class="form-group">
                                <label>Kondisi Perangkat</label>
                                <textarea class="form-control" id="exampleTextarea" required name="kondisi_perangkat" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label>PIC</label>
